    ...
    return (
      <aside className="filters-panel">
        <div className="filters-empty">
          <svg className="filters-empty-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    <aside className="filters-panel">
      <div className="filters-section">
        <div className="filters-header">
          ...
          <span className="filters-count">{searchResult.stats.total.toLocaleString()}</span>
        </div>
      </div>
          ...
          <div className="filters-list">
            {sortedOperators.map(([operator, count]) => (
              <button
                ...
                onClick={() => onOperatorChange(selectedOperator === operator ? null : operator)}
              >
          ...
          <div className="query-debug">
            ...
            {searchResult.query.operator && (
              <div className="query-param">
                ...
                <span className="param-value">{searchResult.query.operator}</span>
              </div>
            )}
